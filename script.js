const desafios = [
    ...
    'se você for mulher, sente no colo de um homem (aleatório), se você for homem, escolha uma mulher (aleatória) pra sentar no seu colo (5 rodadas)',
    ...
    'se você for mulher, rebole no colo de um homem (aleatório), se você for homem, escolha uma mulher (aleatória) para rebolar no seu colo (15 segundos)',
    'fique só de roupa íntima (3 rodadas)',
    'escolha duas pessoas para se beijarem (10 segundos)',
    'se você for mulher, escolha um homem (aleatório) para acariciar seus peitos, se você for homem, acaricie os peitos de alguma mulher (10 segundos) (por baixo da roupa em)',
